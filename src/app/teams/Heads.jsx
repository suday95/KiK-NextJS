    ...
    return (
      ...
      >
        <div className="relative z-[2] flex w-full flex-col items-center space-y-6 group-hover:[transform:translateZ(20px)]">
          ...
          <div className="z-10 flex w-[60%] justify-around gap-4 opacity-100 transition-all duration-300 ease-in-out group-hover:opacity-100 md:opacity-0 md:group-hover:opacity-100">
            {head.facebook && (
              <a
                href={head.facebook}
                target="_blank"
